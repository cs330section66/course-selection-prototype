...
Personas to be addressed by the website include the overacheiver who puts in great effort to try to accomadate her busy schedule. The laided back senior who wants to find the easiest classes. The experience seeker who likes to take a wide range of classes in different departments. The out-of-class experience seeker who would is behind on their major and owuld like to fulfill classes with minimal effort. The planner has a four year plan and makes a schedule way ahead of time. These users all have to make use of information on major requirements, course description, prerequisites, ctec and timing. The differences lie in that some users like the overacheiver would make more use of the timing information than their peers. The out-of-class experience seeker would use degree requirements more. The laid-back senior would make use of the ctec info more. The planner would definetly need to finish their planning over many days. The experience seeker would look for classes based on department while the planner would look through degree requirements. In order to accomodate all these users, the platform would focus on providing easy access to all the above mentioned information and allow for flexibility in the way users focus on using the platform. This flexiblilty would accomodate their different ways of searching for classes.
